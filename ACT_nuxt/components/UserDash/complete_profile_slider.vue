...
<div class="modal_container" :class="{modal_hide_anim: modal_exit_anim, modal_hide_disp: modal_exit_display}">
        ...
        <div class="modal_info">
          ...
          <div class="input_wrap input_wrap_edit_1">
            <input v-model="firm_name" type="text" class="input_white input_edit_1" placeholder=' ' required/>
            <label class="label_white label_move_1">Firm Name<span style="font-size:9px"></span></label>
          </div>
...
function send_more_signup_info(){
  ...
  fetch(`${config.flask_url}/api/user_dashboard/extra_signup_info/`, {
      ...
      body: JSON.stringify({user_ID: user_ID.value, email:email.value, first_name: first_name.value, last_name: last_name.value, firm_name: firm_name.value, job_title: job_title.value, phone_number: phone_number.value, number_of_open: number_of_open.value})
  })
