<template>
    <div class="container_table">      
        <p class="table_title">{{ table_name }}</p>
        <table class="table">
            <thead >
            ...
            <div class="header_row">
                <th v-for="(value, index) in table_headers" :key="index" class="header__item"> 
                    ...
                    <FunderTableRowsOverviewTable v-if="table_row_style == 'overview_table'" :col_num="col_num" :counter_index="counter_index" :show_amount="show_amount"/>
