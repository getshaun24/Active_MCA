...
Merchant_Transactions_Blueprint = Blueprint('MCA_Merchant_Transactions', __name__)
@Merchant_Transactions_Blueprint.route('/api/funder/merchants/merchant_profile/merchant_transactions/', methods=['GET', 'POST']) #
def MCA_Merchant_Transactions():
    ...
    if not session.get("email"):
        ...
        return render_template("/Funder/Merchants/Merchant_Profile/Merchant_Transactions/merchant_transactions.html", transactions=transactions, company_id_var_full=company_id_var_full, company_id_var=company_id_var, access_status=access_status, notification_count=notification_count)
